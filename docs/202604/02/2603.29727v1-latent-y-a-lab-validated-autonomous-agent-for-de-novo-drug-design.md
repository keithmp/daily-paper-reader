...
tags: ["query:q7"]
score: 8.0
evidence: 用于抗体设计和生物信息学工具的AI智能体
tldr: "Latent-Y是一个自主药物设计AI智能体，能根据文本提示完成从文献调研、靶点分析到候选抗体设计的全流程。它集成了Latent-X2生成模型，在9个靶点测试中实现了67%的实验室验证成功率，亲和力达纳摩尔级。该系统将传统数周的工作缩短至数小时，效率提升56倍，且可扩展至多种生物药物设计领域。"
selection_source: fresh_fetch
motivation: 针对传统药物研发流程中专家工作流迭代缓慢、难以并行且扩展性差的挑战，旨在通过AI智能体实现自动化的端到端药物设计。
method: 开发了集成Latent-X2生成模型与生物信息学工具的AI智能体Latent-Y，能够自主执行从文献综述、表位识别到候选序列生成的全链条任务。
result: 在九个靶点的实验中，Latent-Y在无人工干预下成功设计出针对六个靶点的纳米抗体，亲和力达单位数纳摩尔级，且设计速度比人类专家快56倍。
conclusion: Latent-Y证明了AI智能体在自主完成复杂生物药物发现任务方面的可行性与高效性，为加速治疗药物的开发提供了强有力的工具。
---
