...
tags: ["query:q7"]
score: 6.0
evidence: AI辅助的动力系统符号演化
tldr: 本研究针对动力系统控制方程的自动发现问题，提出了一种名为LLM-ODE的新型框架。传统遗传算法在符号搜索空间中效率低下且收敛缓慢，LLM-ODE通过引入大语言模型的生成先验，从精英候选方程中提取模式来引导符号进化。在91个动力系统上的实验表明，该方法在搜索效率、帕累托前沿质量及高维系统扩展性方面均优于传统遗传算法和Transformer模型，为科学发现提供了更高效、准确的数据驱动工具。
